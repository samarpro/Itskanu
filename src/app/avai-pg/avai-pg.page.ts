...
@Component({
  selector: 'app-avai-pg',
  templateUrl: './avai-pg.page.html',
  styleUrls: ['./avai-pg.page.scss'],
})
export class AvaiPgPage implements OnInit {
  ...
  CreateDB() {
    this.n = 1;
    let parent: HTMLElement = document.getElementById("parent_another")!
